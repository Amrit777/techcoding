            ...
            <div class="row">
                <div class="col-xl-6 offset-xl-3 text-center">
                    <div class="breadcrumb_content">
                        <div class="breadcrumb_header">ONE-STOP SOLUTION FOR SETTING UP THE PERFECT</div>
                        <h4 class="breadcrumb_title">Atal Tinkering Labs (ATL)</h4>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Atal Tinkering Labs (ATL)</li>
                        </ol>
                    </div>
                </div>
            </div>
